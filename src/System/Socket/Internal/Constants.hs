...
foreign import capi "hs_socket.h value HS_SIZEOF_SA_FAMILY"
  c_sizeof_sa_family :: CSize
...
foreign import capi "hs_socket.h value HS_SIZEOF_SA_FAMILY6"
  c_sizeof_sa_family6 :: CSize
